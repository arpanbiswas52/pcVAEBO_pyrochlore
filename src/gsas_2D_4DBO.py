...
def gsas(X, fixed_param, iteration):
    ...
    gpx.data["Phases"]["Ho2Ti2O7"]["Atoms"][0][3] = fixed_param[0] #xO1
    gpx.data["Phases"]["Ho2Ti2O7"]["Atoms"][0][6] = 1 #OccO1
    #gpx.data["Phases"]["Ho2Ti2O7"]["Atoms"][0][10] = fixed_param[1] #UO1
    gpx.data["Phases"]["Ho2Ti2O7"]["Atoms"][0][10] = fixed_param[2] #UO1
    ...
    gpx.data["Phases"]["Ho2Ti2O7"]["Atoms"][3][6] = fixed_param[1] #OccO2
    gpx.data["Phases"]["Ho2Ti2O7"]["Atoms"][3][10] = fixed_param[3] #UO2
    ...
    gpx.data["Phases"]["Ho2Ti2O7"]["Atoms"][0][10] = fixed_param[2] #UO1
    gpx.data["Phases"]["Ho2Ti2O7"]["Atoms"][1][6] = params[0] #OccTi
    gpx.data["Phases"]["Ho2Ti2O7"]["Atoms"][1][10] = fixed_param[4] #UTi
    #gpx.data["Phases"]["Ho2Ti2O7"]["Atoms"][2][6] = params[2] #OccHo
    gpx.data["Phases"]["Ho2Ti2O7"]["Atoms"][2][6] = params[1] #OccHo
    gpx.data["Phases"]["Ho2Ti2O7"]["Atoms"][2][10] = fixed_param[5] #UHo
    gpx.data["Phases"]["Ho2Ti2O7"]["Atoms"][3][6] = fixed_param[1] #OccO2
    gpx.data["Phases"]["Ho2Ti2O7"]["Atoms"][3][10] = fixed_param[3] #UO2
    """
    ...
    for row in ref_list:
        ...
        Fobs_i.append(row[5])
        sumchisq = sumchisq + (row[5]-row[7])**2   #/(row[6]**2)
        N += 1
